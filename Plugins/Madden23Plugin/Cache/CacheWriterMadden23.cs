    ...
    public class CacheWriterMadden23 : ICacheWriter
    {
        public void Write()
        {
            ...
            using (NativeWriter nativeWriter = new NativeWriter(msCache, leaveOpen: true))
            {
                ...
                foreach (EbxAssetEntry ebxEntry in AssetManager.Instance.EBX.Values.Distinct())
                {
                ...
                foreach (ResAssetEntry resEntry in AssetManager.Instance.RES.Values.Distinct())
                {
                ...
                foreach (ChunkAssetEntry chunkEntry in AssetManager.Instance.Chunks.Values.Distinct())
                {
