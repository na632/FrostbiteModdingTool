...
namespace CareerExpansionMod.CEM
{
    public class CEMCore
    {
        ...
        {
            var directory = Microsoft.VisualBasic.FileIO.SpecialDirectories.MyDocuments + "\\FIFA 20\\";
        ...
        public static async Task<bool> InitialStartupOfCEM()
        {
            int Attempts = 0;
        ...
        private bool SetupCareerFile(DateTime currentGameDate)
        {
            ...
            {
                CareerFile = new CareerFile(GetMyDocsSaveFileName(), CEMInternalDataDirectory + "fifa_ng_db-meta.XML");
                ...
                CurrentSaveFileName = GetMyDocsSaveFileName();
                //});
