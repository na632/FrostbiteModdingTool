...
namespace v2k4FIFAModdingCL.CGFE
{
	public class Table
	{
		...
		public List<dynamic> ConvertToDynamicList()
		{
			return ConvertDataTableToList<dynamic>(ConvertToDataTable());
		}
        ...
        {
            if (TableDescriptor != null && !string.IsNullOrEmpty(TableDescriptor.TableName))
                return TableDescriptor.TableName;
