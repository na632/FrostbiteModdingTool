...
{
	public class FbxLayerElementArray : FbxNative
	{
		...
		public void GetAt(int index, out Color outValue)
		{
			IntPtr at = GetAt(index, EFbxType.eFbxDouble4);
			outValue = new Color((byte)(BitConverter.Int64BitsToDouble(Marshal.ReadInt64(at, 0)) * 255.0), (byte)(BitConverter.Int64BitsToDouble(Marshal.ReadInt64(at, 8)) * 255.0), (byte)(BitConverter.Int64BitsToDouble(Marshal.ReadInt64(at, 16)) * 255.0), (byte)(BitConverter.Int64BitsToDouble(Marshal.ReadInt64(at, 24)) * 255.0));
			FbxUtils.FbxFree(at);
		}
