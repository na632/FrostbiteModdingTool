...
{
	public class BinarySbReaderV2 : BinarySbReader
	{
		...
		public BinarySbReaderV2(Stream inStream, long inBundleOffset, IDeobfuscator inDeobfuscator)
		...
		private List<object> ReadRes(NativeReader reader)
		{
			...
			foreach (DbObject item in list)
			{
				...
				item.SetValue("resType", (uint)type);
