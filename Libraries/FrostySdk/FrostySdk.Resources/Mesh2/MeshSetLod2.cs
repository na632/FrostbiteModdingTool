...
namespace FrostySdk.FrostySdk.Resources.Mesh2
{
    public class MeshSetLod2
	{
		...
		//public List<MeshSetSection2> Sections { get; } = new List<MeshSetSection2>();
		public List<MeshSetSection2> Sections { get; } = new List<MeshSetSection2>();
		...
		public MeshSetLod2(NativeReader reader, AssetManager am)
		{
			if (reader == null)
			{
		...
		internal void PreProcess(MeshContainer meshContainer, ref uint inInlineDataOffset)
		{
			...
			foreach (MeshSetSection2 section in Sections)
			{
		...
		public bool IsSectionInCategory(MeshSetSection2 section, MeshSubsetCategory category)
		{
			if (section == null)
			{
		...
		public bool IsSectionRenderable(MeshSetSection2 section)
		{
			if (section == null)
			{
				throw new ArgumentNullException("section");
		...
		public void SetSectionCategory(MeshSetSection2 inSection, MeshSubsetCategory category)
		{
			if (inSection == null)
			{
		...
		private int GetSectionIndex(MeshSetSection2 inSection)
		{
