...
{
    public class v2k4EncryptionInterop
    {
        [DllImport("v2k4Encryption.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern char encryptChar(char in_a);
        ...
        [DllImport("v2k4Encryption.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void encryptFile2(string filepath, string to_path); //  string encryptString([MarshalAs(UnmanagedType.LPWStr)]string byteArray);
