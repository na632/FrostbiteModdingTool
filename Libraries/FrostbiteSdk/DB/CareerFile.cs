...
namespace FrostbiteSdk
{
    public class CareerFile
    {
        ...
        public CareerFile(Stream careerFileStream, Stream xmlFileStream)
        {
            LoadXml(xmlFileStream);
            LoadEA(careerFileStream);
        }
        ...
        public bool LoadXml(Stream stream)
        {
            ...
            //m_XmlFileName = xmlFileName;
            m_DescriptorDataSet = new DataSet("XML_Descriptor");
            m_DescriptorDataSet.ReadXml(stream);
            return true;
        }
        ...
        public bool LoadEA(Stream stream)
        {
            DbReader dbReader = new DbReader(stream, FifaPlatform.PC);
