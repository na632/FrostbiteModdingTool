...
namespace FrostySdk.IO
{
	public class BinarySbReader : DbReader
	{
		...
		{
			uint num = ReadUInt(Endian.Big) + 4;
			...
			byte[] array = (ProfilesLibrary.DataVersion == 20181207 || ProfilesLibrary.DataVersion == 20190905) ? ReadToEnd() : ReadBytes((int)(num - Position));
			switch (num2)
			{
			case 3280507699u:
				flag = false;
