...
namespace FrostySdk
{
	internal static class ZStd
	{
		...
		{
			if ((ProfilesLibrary.DataVersion != 20170321 && ProfilesLibrary.DataVersion != 20160927 && ProfilesLibrary.DataVersion != 20170929 && ProfilesLibrary.DataVersion != 20171117 && ProfilesLibrary.DataVersion != 20180807 && ProfilesLibrary.DataVersion != 20180914 && ProfilesLibrary.DataVersion != 20180628 && ProfilesLibrary.DataVersion != 20190911) || Compress != null)
			{
				return;
			}
			...
			else if (ProfilesLibrary.DataVersion == 20180914 || ProfilesLibrary.DataVersion == 20190911)
			{
