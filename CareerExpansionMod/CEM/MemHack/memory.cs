...
/**
 * 
 * https://github.com/Gopinath001/MemoryPatternScanner
 * 
 */
namespace memory
{
    ...
    public class Scanner : Memory
    {
        ...
        public static ulong GetScannerAndReadAddress(string aob)
        {
            Process process = Process.GetProcessesByName("FIFA20")[0];

            //below could be set via constructor or set via setters, check the source.

            Scanner Obj = new Scanner(process, process.Handle, aob);
